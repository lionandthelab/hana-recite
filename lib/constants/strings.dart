class Strings {
  ...
  // Sign In Page
  static const String signIn = '하나암송';
  static const String signInWithEmailPassword = '이메일로 로그인하기';
  static const String goAnonymous = '게스트로 로그인';
  ...
  // Entries page
  static const String entries = '기록';

  // Account page
  static const String account = '내 정보';
  static const String accountPage = '계정 정보';
}
