...
These view models can hold any app-specific business logic, and if they're based on `ChangeNotifier` or `StateNotifier`, they can be easily hooked up to their widgets with corresponding providers. See the [SignInViewModel](https://github.com/bizz84/hanarecite/blob/master/lib/app/sign_in/sign_in_view_model.dart) and [SignInPage](https://github.com/bizz84/hanarecite/blob/master/lib/app/sign_in/sign_in_page.dart) widget for an example of this.
...
See the [FirestoreDatabase](https://github.com/bizz84/hanarecite/blob/master/lib/services/firestore_database.dart) and [FirestoreService](https://github.com/bizz84/hanarecite/blob/master/lib/services/firestore_service.dart) classes for a full picture of how everything fits together.
...
- On Android, use `com.lionandthelab.hanarecite` as the package name.
- then, [download and copy](https://firebase.google.com/docs/flutter/setup#configure_an_android_app) `google-services.json` into `android/app`.
- On iOS, use `com.lionandthelab.hanarecite` as the bundle ID.
